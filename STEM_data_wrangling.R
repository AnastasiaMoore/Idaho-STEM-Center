...
#Define the function to be used for data scraping (for less repetiotion in code)
...
occupations_data <- occupations_data %>% 
  pivot_longer(cols = c(Employment_Change_2018_2028,Employment_Change_2019_2029),
               names_to = "Employment_Change_year",
               values_to = "Employment_Change_2018_2028_2019_2029")

occupations_data <- occupations_data %>% 
  pivot_longer(cols = c(Employment_Percent_Change_2018_2028,Employment_Percent_Change_2019_2029),
               names_to = "Employment_Percent_Change_year",
               values_to = "Employment_Percent_Change_2018_2028_2019_2029")

occupations_data <- occupations_data %>% 
  pivot_longer(cols = c(Median_Hourly_Wage_2018,Median_Hourly_Wage_2019),
               names_to = "Median_Hourly_Wage_year",
               values_to = "Median_Hourly_Wage_2018_2019")

occupations_data <- occupations_data %>% 
  pivot_longer(cols = c(Projected_Annual_Openings_2018_2028,Projected_Annual_Openings_2019_2029),
               names_to = "Projected_Annual_Openings_year",
               values_to = "Projected_Annual_Openings_2018_2028_2019_2029")
